...
/***
 * @title SupraFi Staked Sonic
 * @author SupraFi
 * 
 * ## Put your $S to work. Stake effortlessly, hold $SS, and watch your rewards grow—while keeping your liquidity intact.
 * 
 * ## https://suprafi.app
 * 
 * @notice The contract for SupraFi Staked Sonic (sS)
 */
contract SupraFiSonicStaking is
    IRateProvider,
    Initializable,
    ERC20Upgradeable,
    ...
    ReentrancyGuardUpgradeable
{
    ...
    function initialize(ISFC _sfc, address _treasury) public initializer {
        __ERC20_init("SupraFi Staked Sonic", "sS");
        __ERC20Burnable_init();
        __ERC20Permit_init("SupraFi Staked Sonic");
